...
export const QUESTION_CHOICE_CAPABILITY = "learnfold-question-v1"

// Older iOS builds show this text verbatim because they do not parse question
// fences. Keep their assessment prompt until a client advertises the renderer.
export const LEGACY_COURSE_AGENT_PROMPT = `
