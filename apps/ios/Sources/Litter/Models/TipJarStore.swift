...
final class TipJarStore {
    ...
    private(set) var tiers: [TipTier] = [
        TipTier(id: "com.chirag.learnfold.tip.10", displayName: "$9.99 Tip", fallbackPrice: "$9.99", icon: "tip_cat_10"),
        TipTier(id: "com.chirag.learnfold.tip.25", displayName: "$24.99 Tip", fallbackPrice: "$24.99", icon: "tip_cat_25"),
        TipTier(id: "com.chirag.learnfold.tip.50", displayName: "$49.99 Tip", fallbackPrice: "$49.99", icon: "tip_cat_50"),
        TipTier(id: "com.chirag.learnfold.tip.100", displayName: "$99.99 Tip", fallbackPrice: "$99.99", icon: "tip_cat_100"),
    ]
