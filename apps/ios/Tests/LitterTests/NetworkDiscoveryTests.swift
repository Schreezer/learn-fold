...
final class AgentAssistedPairingTests: XCTestCase {
    func testPromptAsksAgentToPerformSetupWithoutDelegatingCommandsToUser() {
        ...
        XCTAssertTrue(prompt.contains("npx -y learnfold-link@0.3.7 handoff"))
    ...
    func testDisablePromptRevokesPairingsAndStopsAutostartWithoutRemovingHermes() {
        ...
        XCTAssertTrue(prompt.contains("learnfold-link@0.3.7 rotate"))
        XCTAssertTrue(prompt.contains("learnfold-link@0.3.7 uninstall"))
        XCTAssertTrue(prompt.contains("learnfold-link@0.3.7 stop"))
